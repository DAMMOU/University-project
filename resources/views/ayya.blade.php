...
<html class="no-js" lang="en">
    ...
    <head>
		...
		<!--flat icon css-->
		<link rel="stylesheet" href="{{asset('assets/css/flaticon.cs')}}s">
			...
			<div class="clients-area">
				<div class="container">
					<div class="owl-carousel owl-theme" id="client">
						...
						<div class="item">
							<a href="#">
								<img src="{{asset('assets/images/clients/c6.png')}}" alt="brand-image" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
								<img src="{{asset('assets/images/clients/c7.png')}}" alt="brand-image" />
							</a>
						</div><!--/.item-->
					</div><!--/.owl-carousel-->
				</div><!--/.container-->
