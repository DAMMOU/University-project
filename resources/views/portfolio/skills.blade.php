			...
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<div class="single-skill-content">
							<div class="barWrapper">
								<span class="progressText">PHP, JAVA, JavaScript, PYTHON, C/C++ and R</span>
							...
							<div class="barWrapper">
								<span class="progressText">Laravel and Livewire</span>
								<div class="single-progress-txt">
									<div class="progress ">
							...
							<div class="barWrapper">
								<span class="progressText">Sping boot</span>
								<div class="single-progress-txt">
									<div class="progress ">
					...
					<div class="col-md-6">
						<div class="single-skill-content">
							<div class="barWrapper">
								<span class="progressText">html 5, css 3 and Bootstrap </span>
								<div class="single-progress-txt">
									<div class="progress ">
										<div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="10" aria-valuemax="100" style="">
							...
							<div class="barWrapper">
								<span class="progressText">Mathematics</span>
								<div class="single-progress-txt">
									<div class="progress ">
									   <div class="progress-bar" role="progressbar" aria-valuenow="85" aria-valuemin="10" aria-valuemax="100" style="">
