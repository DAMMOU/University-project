                    ...
                    <table class="table table-head-fixed text-nowrap">
                        <thead>
                            <tr>
                                ...
                                <th class="text-cente">Intituté filiére</th>
                                <th class="" >Formations</th>
                        ...
                        <tbody>
                            @foreach ($filieres as $filiere )
                                <tr>
                                    ...
                                    <td class="text-center">{{$filiere->initiale}}</td>
                                    <td class="text-cente">{{$filiere->intitule}}</td>
                                    <td class="">{{$filiere->formation->intitule}}</td>
                                    <td class="text-center">
                                        <button class="btn btn-link"
                                            wire:click="goToUpdate({{$filiere->id}})">
                                            <i class="far fa-edit"></i> 
                                        </button>
                                        <button class="btn btn-link" 
                                            wire:click="confirmDelete('{{$filiere->intitule}}',{{$filiere->id}})">
    ...
    window.addEventListener('showDeleteMessageCONFIRM',event=>{
        ...
        window.addEventListener('showsuccessMessageDELETE',event=>{
            Swal.fire({
                position: 'center',
                icon: 'success',
                title: event.detail.message || 'Filieres suprimé avec succès!',
