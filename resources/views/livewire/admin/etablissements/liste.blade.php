                ...
                <div class="card-header bg-gradient-primary ">
                    ...
                    <div class="card-tools d-flex align-items-center ">
                        <button class="btn btn-link text-white mr-4 d-block" wire:click ="goToAdd">
                            ...
                            Ajouter une nouvelle établissement
                        </button>
                    ...
                    <table class="table table-head-fixed text-nowrap">
                        ...
                        <tbody>
                            @foreach ($etablissements as $etablissement )
                                <tr>
                                    <td class="text-center">{{$etablissement->id}} </td>
                                    <td class="text-center">{{$etablissement->initiale}} </td>
                                    <td class="">{{$etablissement->nom}}</td>
                                    <td class="">{{$etablissement->universite->initiale}}</td>
                                    <td class="text-center">{{$etablissement->ville->nom}}</td>
                                    <td class="text-center">
                                        <button class="btn btn-link" wire:click="goToUpdate({{$etablissement->id}})"><i class="far fa-edit"></i> </button>
                                        <button class="btn btn-link" wire:click="confirmDelete('{{$etablissement->nom}}',{{$etablissement->id}})"><i class="far fa-trash-alt"></i> </button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
