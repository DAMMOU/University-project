                        ...
                        <tbody>
                            @foreach ($types as $type )
                                <tr>
                                    ...
                                    <td class="text-center">{{$type->label}} </td>
                                    <td class="">{{$type->desc}}</td>
                                
                                    <td class="text-center">
                                        <button class="btn btn-link" wire:click="goToUpdate({{$type->id}})"><i class="far fa-edit"></i> </button>
                                        <button class="btn btn-link" wire:click="confirmDelete('{{$type->label}}',{{$type->id}})"><i class="far fa-trash-alt"></i> </button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
