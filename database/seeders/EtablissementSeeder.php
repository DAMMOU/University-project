...
class EtablissementSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('etablissements')->insert([
            ...
            ['ville_id'=>2,'categorie_etablissement_id'=>1,'type_etablissement_id'=>2,'universite_id'=>2,'nom'=>"Ecole Supérieure de Technologie"],
            ['ville_id'=>2,'categorie_etablissement_id'=>1,'type_etablissement_id'=>2,'universite_id'=>2,'nom'=>"Ecole Nationale des Sciences Appliquées"],
            ['ville_id'=>2,'categorie_etablissement_id'=>1,'type_etablissement_id'=>3,'universite_id'=>2,'nom'=>"Ecole Nationale de Commerce et de Gestion"],
            ...
            ['ville_id'=>3,'categorie_etablissement_id'=>1,'type_etablissement_id'=>2,'universite_id'=>3,'nom'=>"Ecole Nationale de Commerce et de Gestion"],
            ['ville_id'=>3,'categorie_etablissement_id'=>1,'type_etablissement_id'=>2,'universite_id'=>3,'nom'=>"Ecole Nationale des Sciences Appliquées"],
            ['ville_id'=>3,'categorie_etablissement_id'=>1,'type_etablissement_id'=>2,'universite_id'=>3,'nom'=>"Ecole Nationale des Sciences Appliquées"],
            ['ville_id'=>3,'categorie_etablissement_id'=>1,'type_etablissement_id'=>2,'universite_id'=>3,'nom'=>"Ecole Supérieure de l'Éducation et de la Formation"],
            ['ville_id'=>3,'categorie_etablissement_id'=>1,'type_etablissement_id'=>2,'universite_id'=>3,'nom'=>"Ecole Supérieure de Technologie "],
            ['ville_id'=>3,'categorie_etablissement_id'=>1,'type_etablissement_id'=>2,'universite_id'=>3,'nom'=>"Ecole Supérieure de Technologie"],
            ['ville_id'=>3,'categorie_etablissement_id'=>1,'type_etablissement_id'=>2,'universite_id'=>3,'nom'=>"Ecole Supérieure de Technologie"],
            ...
            ['ville_id'=>4,'categorie_etablissement_id'=>1,'type_etablissement_id'=>2,'universite_id'=>4,'nom'=>"College of Shari'ah"],
            ['ville_id'=>4,'categorie_etablissement_id'=>1,'type_etablissement_id'=>2,'universite_id'=>4,'nom'=>"Centre de la Formation Continue (CFCC)"],
            ['ville_id'=>4,'categorie_etablissement_id'=>1,'type_etablissement_id'=>2,'universite_id'=>4,'nom'=>"Faculté Polydisciplinaire"],
            ...
            ['ville_id'=>7,'categorie_etablissement_id'=>1,'type_etablissement_id'=>2,'universite_id'=>7,'nom'=>"Ecole Normale Supérieure"],
